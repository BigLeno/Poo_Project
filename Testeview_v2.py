...
class app_view:
    ...
    def filtrar_items(self):
        ...
        if item_lojas != "Selecione uma loja":
            ...
            for mark in self.lista_localizacoes:
                if mark == item_lojas:
    ...
    def inicializa_marcadores(self):
        for mercado in self.lista_localizacoes:
            mark = mercado
            self.criar_marcador(mark.coordenadas,mark.nome_mercado)
...
class Produtos_dados:
    def __init__(self, produto, mercado, preco):
...
class Mercado_local:
    def __init__(self, mercado, coordenadas):
        self.nome_mercado = mercado
